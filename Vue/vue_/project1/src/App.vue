<template>
  ...
  <LessonFive v-bind:web="web" /> <!-- 버전 2, 3 다를 수 있다. (업데이트에 따라~) -->
  <LessonFive :web="web" /> <!-- 버전 2, 3 다를 수 있다. (업데이트에 따라~)  -->
  
  <LessonSix />
  <LessonSeven />
  <hr>
  <div>
    <p>수강 개월 수 : <input type="text" id="month" v-model="month" placeholder="수강가능한 개월수 입력"></p>
  </div>
...
import LessonFive from './LessonFive.vue';
import LessonSix from './components/LessonSix.vue';
import LessonSeven from './LessonSeven.vue';
...
export default {
  ...
  components: { // component : 긴 HTML을 한 단어로 줄일 수 있는 문법, 반복적인 부분 재사용 쉬움
    LessonOne,
    LessonTwo,
    LessonThree,
    LessonFour,
