...
(function($) {
    $.fn.rProgressbar = function(options) {
        options = $.extend({ percentage: null, ShowProgressCount: true, duration: 2000, fillBackgroundColor: '#ed1c24', backgroundColor: '#eeeeee', borderRadius: '0px', height: '20px', width: '450px' }, options);
        $.options = options;
